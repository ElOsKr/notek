            ...
            <div class="container cajaTotal text-white mt-5 px-5">
                ...
                <div class="row cajaIntroducirLista">
                    <div class="list-group pe-0">
                        <a href="#lista1" class="list-group-item list-group-item-action grupoLista" aria-current="true">
                            Lista 1
                        </a>
                        <a href="#gruposOtakus" class="list-group-item list-group-item-action grupoLista ">Grupos otakus</a>
                        <a href="#" class="list-group-item list-group-item-action grupoLista ">Grupo de estudio</a>
                        <a href="#" class="list-group-item list-group-item-action grupoLista ">Aqui studying</a>
                    </div>
                    <button type="button" id="crearGrupo" class="btn btn-info text-white mt-4 mx-auto ">Crear Grupo</button>
                </div>
            </div>
        </div>
        <div class="content">
